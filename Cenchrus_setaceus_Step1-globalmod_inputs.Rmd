---
title: "Cenchrus setaceus - Preparing Global Model Inputs"
author: "Kelsey Brock"
...
```
```{r}
pres$Species <- gsub("Pennisetum_setaceum", 1, pres$Species)
head(pres, 2)
```
...
pseu.srs2 <- pseu.bufpt[sample(1:nrow(pseu.bufpt), 7.5 * table(p1$Species)[[1]], replace = F), ]
...
```
```{r}
keep <- c("bio1", "bio3", "bio10", "bio16", "bio18", "bio19", "alt")
